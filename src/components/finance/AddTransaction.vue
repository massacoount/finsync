  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-100">
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
      ...
      <form @submit.prevent="handleAddTransaction" class="space-y-4">
        ...
        <div>
          <label for="debitAccount" class="block text-sm font-medium text-gray-700">Debit Account</label>
          <select
            id="debitAccount"
        ...
        <div>
          <label for="creditAccount" class="block text-sm font-medium text-gray-700">Credit Account</label>
          <select
            id="creditAccount"
...
export default {
  setup() {
    ...
    return { date, description, debitAccount, creditAccount, amount, accounts, handleAddTransaction };
  },
};
</script>
